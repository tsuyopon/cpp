// https://zookeeper.apache.org/doc/r3.3.3/zookeeperProgrammers.html#ch_programStructureWithExample
#include <string.h>
#include <errno.h>
...
//  struct ACL_vector CREATE_ONLY = {1, CREATE_ONLY_ACL};
  int rc = zoo_create(zh,"/zk_test","value", 5, &ZOO_OPEN_ACL_UNSAFE, ZOO_EPHEMERAL, buffer, sizeof(buffer)-1);
